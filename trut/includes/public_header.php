				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="#">TruTed</a></div>
							<nav class="main_nav">
								<ul>
                        ...
                        while ($row =mysqli_fetch_assoc($result)){
											...
											echo "<li><a href='product.php?cat_id={$row['cat_id']}'>{$row['cat_name']}</a></li>";
									...
									<li><a href="offers.php">Auction</a></li>
									<li><a href="contact.php">Contact</a></li>
								</ul>
							</nav>
		...
		<div class="menu_container menu_mm">
			<div class="page_menu_content">
				...
				<ul class="page_menu_nav menu_mm">
					...
					<li class="page_menu_item menu_mm"><a href="offers.php">Offers<i class="fa fa-angle-down"></i></a></li>
					<li class="page_menu_item menu_mm"><a href="contact.php">Contact<i class="fa fa-angle-down"></i></a></li>
				</ul>
			</div>
		</div>
