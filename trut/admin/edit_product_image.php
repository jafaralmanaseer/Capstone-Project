...
echo "<script> window.top.location='manage_product_image.php'; </script>";  } /* Back to manage admin page */
                    ...
                    <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                      ...
                      <span class="section">product Info</span>
                       ...
                       <div class="item form-group">
                        <label for="password2" class="col-form-label col-md-3 col-sm-3 label-align ">Producte ID</label>
